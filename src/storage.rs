...
//     async fn get(&self, path: &str) -> Result<Key, Rejection>;
//     async fn list(&self) -> Result<KeyCollection, Rejection>;
// }
...
//     pub fn new(url: &str) -> RedactKeyStorer {
//         RedactKeyStorer {
//             url: url.to_owned(),
//         }
//     }
...
//     async fn get(&self, name: &str) -> Result<Key, Rejection> {
